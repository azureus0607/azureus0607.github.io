...
<?php 
    ...
    $diffanswer = $firstnumber - $secondnumber ;
    $proanswer = $firstnumber * $secondnumber ;
    $quotanswer =$firstnumber / $secondnumber ;
    echo "<br><h4 class='bg-dark text-center m-auto p-2'
     style='width: 400px; color: white;'>
    The sum is... $sumanswer<br>
    The difference is... $diffanswer<br>
    The product is... $proanswer<br>
    The quotient is... $quotanswer</h4> ";
