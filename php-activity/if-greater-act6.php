...
function calculate($num1, $num2){
    ...
    <h1 class='big-number float-start text-start fw-bold' style=' width:150px;' >$num1</h1>
    <h1 class='big-number float-start text-center x' style=' width:80px;' >EQUAL</h1>
    <h1 class='small-number float-end text-start fw-bold' style='width:50px;'>$num2</h1>
